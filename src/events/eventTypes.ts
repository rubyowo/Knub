...
export const fromDjsArgs = createFromDjsArgsObject({
  ...
  entitlementCreate: (entitlement: Entitlement) => ({ entitlement }),
  entitlementDelete: (entitlement: Entitlement) => ({ entitlement }),
  ...
  messageCreate: (message: OmitPartialGroupDMChannel<Message>) => ({ message }),
  messageDelete: (message: OmitPartialGroupDMChannel<Message | PartialMessage>) => ({ message }),
  messageDeleteBulk: (
    messages: ReadonlyCollection<Snowflake, OmitPartialGroupDMChannel<Message | PartialMessage>>,
  ) => ({ messages }),
  messagePollVoteAdd: (pollAnswer: PollAnswer, userId: Snowflake) => ({ pollAnswer, userId }),
  messagePollVoteRemove: (pollAnswer: PollAnswer, userId: Snowflake) => ({ pollAnswer, userId }),
  ...
  messageReactionRemoveAll: (message: OmitPartialGroupDMChannel<Message | PartialMessage>) => ({ message }),
