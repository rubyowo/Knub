...
import { AnyGlobalPluginBlueprint, AnyGuildPluginBlueprint, GlobalPluginBlueprint, GuildPluginBlueprint } from "./plugins/PluginBlueprint";
...
export type LogFn = (level: any, ...args: any[]) => void;
