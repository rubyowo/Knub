...
export type OptionsFromSignature<TSignature extends SlashCommandSignature> = {
    [Opt in TSignature[number] as Opt["name"]]: Opt["required"] extends true ? ReturnType<Opt["resolveValue"]> : ReturnType<Opt["resolveValue"]> | null;
};
...
export type SlashCommandFn<TPluginData extends AnyPluginData<any>, TSignature extends SlashCommandSignature> = (meta: SlashCommandMeta<TPluginData, TSignature>) => void | Promise<void>;
