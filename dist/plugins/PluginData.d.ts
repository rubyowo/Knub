...
export type AnyPluginData<TPluginType extends BasePluginType> = GuildPluginData<TPluginType> | GlobalPluginData<TPluginType>;
export declare function isGuildPluginData<TPluginType extends BasePluginType>(pluginData: AnyPluginData<TPluginType> | BasePluginData<TPluginType>): pluginData is GuildPluginData<TPluginType>;
export declare function isGlobalPluginData<TPluginType extends BasePluginType>(pluginData: AnyPluginData<TPluginType> | BasePluginData<TPluginType>): pluginData is GlobalPluginData<TPluginType>;
