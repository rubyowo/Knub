import { MessageContextMenuCommandBlueprint, UserContextMenuCommandBlueprint } from "../commands/contextMenuCommands/contextMenuCommandBlueprint";
...
export interface BasePluginBlueprint<TPluginData extends AnyPluginData<any>, TPublicInterface> {
    ...
    contextMenuCommands?: Array<MessageContextMenuCommandBlueprint<TPluginData> | UserContextMenuCommandBlueprint<TPluginData>>;
    /**
 ...
 */
export interface GuildPluginBlueprint<TPluginData extends GuildPluginData<any>, TPublicInterface> extends BasePluginBlueprint<TPluginData, TPublicInterface> {
    /**
...
export type AnyGuildEventListenerBlueprint<TPluginData extends GuildPluginData<any>> = GuildEventListenerBlueprintsHelper<TPluginData>[keyof GuildEventListenerBlueprintsHelper<TPluginData>];
/**
 * Blueprint for a plugin that can only be loaded in a global context
 */
export interface GlobalPluginBlueprint<TPluginData extends GlobalPluginData<any>, TPublicInterface> extends BasePluginBlueprint<TPluginData, TPublicInterface> {
    /**
     * Function that returns other plugins that are required for this plugin to function.
     * They will be loaded before this plugin.
     */
...
export type AnyGlobalEventListenerBlueprint<TPluginData extends GlobalPluginData<any>> = GlobalEventListenerBlueprintsHelper<TPluginData>[keyof GlobalEventListenerBlueprintsHelper<TPluginData>];
...
export type GuildPluginBlueprintCreator<TPluginData extends GuildPluginData<any>> = <TPublicInterface>(blueprint: GuildPluginBlueprint<TPluginData, TPublicInterface>) => GuildPluginBlueprint<TPluginData, TPublicInterface>;
/**
 ...
 */
export declare function guildPlugin<TPluginData extends GuildPluginData<any>, TPublicInterface>(blueprint: GuildPluginBlueprint<TPluginData, TPublicInterface>): GuildPluginBlueprint<TPluginData, TPublicInterface>;
/**
 * Helper function with no arguments. Specify `TPluginType` for type hints and return self.
 */
export declare function guildPlugin<TPluginType extends BasePluginType>(): GuildPluginBlueprintCreator<GuildPluginData<TPluginType>>;
export type GlobalPluginBlueprintCreator<TPluginData extends GlobalPluginData<any>> = <TPublicInterface>(blueprint: GlobalPluginBlueprint<TPluginData, TPublicInterface>) => GlobalPluginBlueprint<TPluginData, TPublicInterface>;
/**
 ...
 */
export declare function globalPlugin<TPluginData extends GlobalPluginData<any>, TPublicInterface>(blueprint: GlobalPluginBlueprint<TPluginData, TPublicInterface>): GlobalPluginBlueprint<TPluginData, TPublicInterface>;
/**
 * Helper function with no arguments. Specify `TPluginType` for type hints and return self
 */
export declare function globalPlugin<TPluginType extends BasePluginType>(): GlobalPluginBlueprintCreator<GlobalPluginData<TPluginType>>;
export type GetPluginBlueprintPluginDataType<TBlueprint extends BasePluginBlueprint<any, any>> = TBlueprint extends BasePluginBlueprint<infer R, any> ? R : never;
export {};
